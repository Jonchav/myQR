...
import { Palette, Frame, Sparkles, Loader2, Home, ArrowLeft, X, Maximize2, Upload, Type } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          <Card className="border-purple-200 dark:border-purple-700">
            <CardHeader className="pb-3">
              ...
              <p className="text-sm text-muted-foreground">
                Añade texto alrededor del QR para mejor comunicación
              </p>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => applyRealTimeChange("includeText", e.target.checked)}
                  className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                />
                <Label htmlFor="includeText">Incluir texto</Label>
              </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      <Button
                        ...
                        size="sm"
                        onClick={() => applyRealTimeChange("textPosition", "top")}
                        className="flex items-center gap-1"
                      >
                        ↑ Arriba
                      </Button>
                      <Button
                        ...
                        size="sm"
                        onClick={() => applyRealTimeChange("textPosition", "bottom")}
                        className="flex items-center gap-1"
                      >
                        ↓ Abajo
                      </Button>
                      <Button
                        variant={settings.textPosition === "left" ? "default" : "outline"}
                        size="sm"
                        onClick={() => applyRealTimeChange("textPosition", "left")}
                        className="flex items-center gap-1"
                      >
                        ← Izquierda
                      </Button>
                      <Button
                        variant={settings.textPosition === "right" ? "default" : "outline"}
                        size="sm"
                        onClick={() => applyRealTimeChange("textPosition", "right")}
                        className="flex items-center gap-1"
                      >
                        → Derecha
                      </Button>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1"
                        />
                        <span className="text-sm font-mono w-10">{settings.textSize}px</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={(e) => applyRealTimeChange("textBold", e.target.checked)}
                        className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                      />
                      <Label htmlFor="textBold">Negrita</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <input
                        type="checkbox"
                        ...
                        onChange={(e) => applyRealTimeChange("textShadow", e.target.checked)}
                        className="rounded border-gray-300 text-purple-600 focus:ring-purple-500"
                      />
                      <Label htmlFor="textShadow">Sombra</Label>
                    </div>
                  </div>
                </div>
              )}
