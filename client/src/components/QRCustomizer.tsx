    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center gap-6">
          ...
          {/* Botones Aplicar y Deshacer - siempre centrados */}
          <div className="flex flex-row gap-3 items-center justify-center p-4 bg-gray-50/30 dark:bg-gray-800/30 rounded-xl">
            <Button
              onClick={onGenerate}
